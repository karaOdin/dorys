                       ...
                       <nav class="navbar navbar-expand-lg navbar-light">
                          ...
                          <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                              ...
                              {{-- <aclass="nav-link"href="route('welcome',app()->getLocale()) --}}">{{__("drepanocytose")}} </a>
                              </li>
                              <li class="nav-item">
                             {{-- <aclass="nav-link"href="route('dorys',app()->getLocale()) }}" >dorys</a>
                              </li>
                             {{-- <li class="nav-item">
                             <a class="nav-link " href="{{route('patient',app()->getLocale()) }}"  >patients</a>
                              </li> --}}
                               <li class="nav-item">
                             {{-- <aclass="nav-link"href="route('congrè',app()->getLocale()) }}" ><p>{{ __("congre") }}</p></a>
                             --}} </li>
                               <li class="nav-item">
                                <a class="nav-link " href= "route('Auth.login',app()->getLocale()) }} ">espace membre</a>
                              </li>
                               <li class="nav-item">
